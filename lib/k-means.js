    ...
    function SuperiorKMeans() {
        ...
        this.compute = function() {
            ...
            for(let i = 0; i < _numberOfCentroids; i++) {
                ...
                _centroids[i].initCenterValues(_multiDimensionalVectorLength[i]);
            }
            
            function euclideanDistance(arr, other) {
                var l = arr.length;
            ...
            while(iteration++ < _maxIterations) {
                ...
                for(let d_i = 0; d_i < _multiDimensionalVectorLength; d_i++) {
                    ...
                    for(let c_i = 0; c_i < _numberOfCentroids; c_i++) {
                        if(euclideanDistance(_multiDimensionalVector[d_i], _centroids[c_i]) < min) {
                            closestCentroid = c_i;
                        }
                    }
